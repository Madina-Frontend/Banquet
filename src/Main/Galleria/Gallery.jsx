...
export default function Gallery() {
  ...
  return (
    <>
    <h1 className=" text-[30px]">Stol va stullar</h1>
      <div type="button" className=" grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4" onClick={() => setOpen(true)}>
        ...
        <img className=" w-[100%] h-[250px] object-cover rounded-lg" src="https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHRhYmxlfGVufDB8fDB8fHww" alt="" />
      ...
      <Lightbox
        ...
        slides={[
          ...
          {
            src: "https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHRhYmxlfGVufDB8fDB8fHww",
            alt: "image 2",
            width: 3840,
            height: 2560,
          },
